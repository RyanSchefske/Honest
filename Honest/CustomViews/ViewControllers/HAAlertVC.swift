...
class HAAlertVC: UIViewController {
    ...
    let actionButton = HAButton(backgroundColor: Colors.customBlue, title: "Okay")
    ...
    func configureActionButton() {
        actionButton.setTitle(buttonText ?? "Okay", for: .normal)
